export const translations = {
  uz: {
    ...
    testi_1_text:
      "O'g'lim kitob sahifalarida o'zini ritsar kiyimida ko'rib, hayratda qoldi! Bu haqiqiy jonlangan sehr va butun umrga tatigulik xotiradir.",
    testi_2_role: "Malikaning otasi",
    testi_2_text:
      "Tasvirlar sifati hayratlanarli. Biz avval faqat tasavvur qila olgan dunyoga go'yo nazar soldik.",
    testi_3_role: "Hikoyalar saqlovchisi",
    testi_3_text:
    ...
    step_1_text:
      "Kitob sahifasidagi maxsus QR-kodni telefon kamerasi orqali oching.",
    ...
    diary_summary:
      "Hayot — lahzalar to‘plamidir. Bu yerda eng qadrli xotiralar, shirin sog‘inchlar va yaqinlaringiz bilan bog‘liq lahzalar mangu muhrlanadi. Bu shunchaki kitob emas — bu sizning shaxsiy tarixingizdir.",
    ...
    about_description:
      "Biz har bir lahzani san'at asariga aylantiramiz. Bizning kitoblarimiz shunchaki qog'oz emas, bu sizning oilaviy tarixingiz va farzandingizning mo'jizaviy dunyosidir.",
    about_description_2:
    ...
    plus_1_desc:
      "Har bir ertak qahramoni farzandingizga 1:1 nisbatda o'xshash qilib yaratiladi.",
    plus_2_title: "Premium sifat",
    plus_2_desc:
      "Yillar davomida o'z ko'rinishini yo'qotmaydigan eng yuqori sifatli materiallar.",
    plus_3_title: "Eko-do'stona",
    plus_3_desc:
      "Bolalar uchun mutlaqo xavfsiz bo'lgan tabiatga zarar yetkazmaydigan bo'yoqlar.",
    ...
    title_2: "Mangu lahzalar sehri",
    desc_2:
      "Vaqt o‘tkinchi, ammo haqiqiy tuyg‘ular abadiy qoladi. Ushbu kitob xotiralaringizni hech qachon so‘nmaydigan jonli hikoyaga aylantiradi.",

    title_3: "Tug‘yolaringizning shaxsiy arxivi",
    desc_3:
      "Bu yerda shunchaki voqealar emas, balki sizning hissiyotlaringiz va ilhomingiz yashaydi. Har bir detal eng muhim va qadrli lahzalarni yodga soluvchi shinam makondir.",

    title_4: "Yaqinlar uchun eng samimiy sovg‘a",
    desc_4:
      "Aziz insonlaringizga umumiy tarixingizning eng go‘zal damlarini qayta yashash imkoniyatini bering. Bu shunchaki sovg‘a emas — bu muhabbat va sadoqat izhoridir.",

    title_5: "Noyob hayotingiz yilnomasi",
    desc_5:
      "Hayotning har bir bosqichi o‘ziga xos go‘zal va muhrlanishga loyiqdir. Biz tarqoq lahzalarni yagona, go‘zal va uyg‘un kitob holiga keltirishga yordam beramiz.",
  ...
  ru: {
    ...
    testi_1_text:
      "Мой сын был в восторге, увидев себя в доспехах на страницах книги! Это настоящее ожившее волшебство и бесценная память на всю жизнь.",
    testi_2_role: "Отец принцессы",
    testi_2_text:
      "Качество иллюстраций поражает. Мы словно заглянули в мир, который раньше могли только воображать.",
    ...
    step_1_text:
      "Откройте специальный QR-код на странице книги с помощью камеры телефона.",
    ...
    soon: "Другая книга",
    diary_summary:
      "Жизнь — это коллекция мгновений. Здесь вечно хранятся самые дорогие воспоминания, нежная ностальгия и моменты, связанные с близкими людьми. Это не просто книга, это ваша личная история.",
    text: "Дневник памяти",
    ...
    about_description:
      "Мы превращаем каждое мгновение в произведение искусства. Наши книги — это не просто бумага, это ваша семейная история и волшебный мир вашего ребенка.",
    about_description_2:
      "Ведущая студия персонализированных сказок в Ташкенте. Мы превращаем каждое мгновение в произведение искусства, создавая уникальный волшебный мир, где ваш ребенок — главный герой. Наши книги — это не просто бумага, это гармония вашей семейной истории и премиального качества исполнения в самом сердце столицы.",
    plus_1_title: "Индивидуальный подход",
    plus_1_desc:
      "Каждый герой сказки создается с портретным сходством вашего ребенка 1:1.",
    plus_2_title: "Премиум качество",
    plus_2_desc:
      "Высококачественные материалы, которые сохранят свой вид на долгие десятилетия.",
    plus_3_title: "Эко-дружелюбность",
    plus_3_desc:
      "Использование абсолютно безопасных и экологически чистых красок для детей.",
    ...
    desc_1:
      "Ваша личная история — это бесценный дар для ваших детей и внуков. Каждая страница бережно хранит семейные ценности и самые тёплые моменты прошлого.",

    title_2: "Магия вечных мгновений",
    desc_2:
      "Время быстротечно, но истинные чувства остаются навсегда. Эта книга превращает ваши воспоминания в живую повествовательную нить, которая не гаснет.",

    title_3: "Личный архив ваших чувств",
    desc_3:
      "Здесь живут не просто события, а ваши эмоции и вдохновение. Это уютное пространство, где каждая деталь напоминает о самом важном и сокровенном.",

    title_4: "Самый искренний подарок близким",
    desc_4:
      "Подарите дорогим людям возможность заново прожить лучшие моменты вашей общей истории. Это больше чем подарок — это признание в любви и преданности.",

    title_5: "Летопись вашей уникальной жизни",
    desc_5:
      "Каждый этап жизни прекрасен по-своему и достоин быть запечатлённым. Мы помогаем собрать разрозненные мгновения в единую, красивую и гармоничную книгу.",
